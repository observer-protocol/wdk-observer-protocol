...
- **[`@observer-protocol/wdk-protocol-trust`](https://github.com/observer-protocol/wdk-protocol-trust)** — WDK protocol module providing AIP v0.6 trust handshake, DID/VC identity, and ERC-8004 attestation. Conforms to `@tetherto/wdk` v1.0.0-beta.9. Available on npm: `npm install @observer-protocol/wdk-protocol-trust@beta`
